...
public interface Coding extends Creatable {
    @OccProtocolInstanceMethod("encodeWithCoder:")
    void encode(Coder encoder);

//    //Can't do this because of a bug in JDK 6 javac
//    @Override
//    CodingFactory getFactory();
}
