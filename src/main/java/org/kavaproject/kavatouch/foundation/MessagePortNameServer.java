...
@Header("NSMessagePortNameServer")
@OccClass(value = "NSMessagePortNameServer", osxOnly = true)
public interface MessagePortNameServer extends PortNameServer, Creatable {
    ...
    @Override
    MessagePortNameServerFactory getFactory();
}
