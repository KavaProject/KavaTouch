...
public interface NotificationQueueFactory extends Factory {
    @OccInstanceMethod("initWithNotificationCenter:")
    NotificationQueue create(NotificationCenter notificationCenter);

    @OccClassMethod("defaultQueue")
