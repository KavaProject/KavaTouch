...
public class GraphicsImageDestinationProperties {
    @CData("kCGImageDestinationLossyCompressionQuality")
    public Float lossyCompressionQuality;
    @CData("kCGImageDestinationBackgroundColor")
    public GraphicsColor backgroundColor;
}
